...
class FileStatus(str, enum.Enum):
    """Draft -> Active -> Released lifecycle. 'dispatched' is a separate,
    independent terminal state reachable only via the Dispatch subsystem."""
    draft      = "draft"
    active     = "active"
...
class RouteAction(str, enum.Enum):
    """Only Forward moves a file through the workflow. Dispatch is a separate,
    independent action used by the Dispatch subsystem."""
    forward  = "forward"
    dispatch = "dispatch"
